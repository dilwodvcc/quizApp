    ...
    <main class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex space-x-4">
                <a href="/create-quiz" class="bg-indigo-600 text-white px-4 py-2 rounded-lg hover:bg-indigo-700">
                    Create New Quiz
                </a>
...
`
                ...
                .catch(error => {
                    alert("Internetda muammoga duch kelindi togirlab qayta ishlang :)");
                });
        }
        quizzes()
        ...
        const copyContent = async (uniqueValue) =>
        {
            try
            {
                uniqueValue = '<?= $_ENV['APP_URL']?>' + '/take-quiz/' + uniqueValue
